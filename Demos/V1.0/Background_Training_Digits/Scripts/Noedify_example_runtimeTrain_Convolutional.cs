...
public class Noedify_example_runtimeTrain_Convolutional : MonoBehaviour
{
    ...
    */
    ...
    public void TrainModel()
    {
        ...
        Noedify_Utils.ImportImageData(ref trainingData, ref outputData, MNIST_images, true); debugger.net = net;
        ...
        solver.TrainNetwork(net, Noedify_Utils.ConvertInputList(trainingData), outputData, no_epochs, batch_size, trainingRate, costFunction, solverMethod, null, 8);
    ...
    IEnumerator PlotCostWhenComplete(Noedify_Solver solver, float[] cost)
    {
        ...
        for (int n = 0; n < predictionTester.sampleImagePlanes.Length; n++) {
            ...
            solver.Evaluate(net, new Noedify.InputArray(testInputImage), Noedify_Solver.SolverMethod.MainThread);
