    ...
    public IEnumerator TrainNetwork()
    {
        if (trainingSet != null)
        {
            if (trainingSet.Count > 0)
            {
                ...
                trainingSolver.TrainNetwork(net, Noedify_Utils.ConvertInputList(observation_inputs), decision_outputs, trainingEpochs, trainingBatchSize, trainingRate, Noedify_Solver.CostFunction.MeanSquare, Noedify_Solver.SolverMethod.MainThread, trainingSetWeights, N_threads);
            }
        }
    }
#endif
